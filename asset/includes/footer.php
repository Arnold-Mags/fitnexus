...
<div class="container-fluid bg-dark text-secondary px-5 mt-5">
        <div class="row gx-5">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="class.php"><i class="bi bi-arrow-right text-primary me-2"></i>Schedules</a>
                            <a class="text-secondary mb-2" href="team.php"><i class="bi bi-arrow-right text-primary me-2"></i>Our Trainers</a>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="col-lg-4 col-md-12 pt-5 mb-5 text-start">
